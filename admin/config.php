<?php
// HTTP
define('HTTP_SERVER', 'https://smartcool.local/admin/');
define('HTTP_CATALOG', 'https://smartcool.local/');

// HTTPS
define('HTTPS_SERVER', 'https://smartcool.local/admin/');
define('HTTPS_CATALOG', 'https://smartcool.local/');
